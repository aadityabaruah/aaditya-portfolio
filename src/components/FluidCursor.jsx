...
const FluidCursor = () => {
    ...
    useEffect(() => {
        ...
        let config = {
            ...
            DYE_RESOLUTION: 512,       // Reduced from 1024 - still looks great
            CAPTURE_RESOLUTION: 256,   // Reduced from 512
            DENSITY_DISSIPATION: 1.2,  // Slightly faster dissipation
            VELOCITY_DISSIPATION: 0.03,
            PRESSURE: 0.8,
            PRESSURE_ITERATIONS: 12,   // Reduced from 20 - major CPU savings
            CURL: 25,                  // Slightly reduced
            SPLAT_RADIUS: 0.05,
            SPLAT_FORCE: 5000,         // Slightly reduced
            SHADING: true,
            COLORFUL: true,
            ...
            BLOOM_SOFT_KNEE: 0.7,
            SUNRAYS: false,
            SUNRAYS_RESOLUTION: 128,   // Reduced from 196
            SUNRAYS_WEIGHT: 1.0,
        };
        ...
        // Event handlers - Always track mouse movement (no click required)
        pointers[0].down = true; // Always active
        ...
        // Touch events - listen on window since canvas has pointerEvents: none
